 ...
 */
public class BlogAccountDialogEventHandler {

    public static class _BlogAccountDialogEventHandler extends WeakBase
         ...
         */
        public static String[] SupportedWindowNames = {"BlogAccountPage"};
        /**
         * Names of the controls which are supported by this handler. All these
         * controls must have a "Text" property.
         */
        public static String[] ControlNames = {"txtBlogURL", "txtUserName", "txtPassword", "txtImagesBaseURL"};
        static private final String __serviceName = "com.envox.webpublish.BlogAccountDialogEventHandler";
        private XComponentContext context;
        private XNameAccess accessLeaves;

        public _BlogAccountDialogEventHandler(XComponentContext xCompContext) {
            this.context = xCompContext;
            this.accessLeaves = ConfigurationAccess.createUpdateAccess(context,
                    "/com.envox.webpublish.BlogAccountPage/Leaves");
        }
        ...
        public String getImplementationName() {
            return _BlogAccountDialogEventHandler.class.getName();
        }
        ...
        public boolean callHandlerMethod(com.sun.star.awt.XWindow aWindow, Object aEventObject, String sMethod)
            ...
            if (sMethod.equals("external_event")) {
                try {
                    ...
                    Logger.getLogger(_BlogAccountDialogEventHandler.class.getName()).log(Level.SEVERE, null, re);
                    throw re;
                } catch (com.sun.star.uno.Exception e) {
                    Logger.getLogger(_BlogAccountDialogEventHandler.class.getName()).log(Level.SEVERE, null, e);
        ...
        private boolean handleExternalEvent(com.sun.star.awt.XWindow aWindow, Object aEventObject)
            ...
            try {
                ...
                Logger.getLogger(_BlogAccountDialogEventHandler.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static XSingleComponentFactory __getComponentFactory(String sImplName) {
        System.out.println("OptionsDialogEventHandler::_getComponentFactory");
        XSingleComponentFactory xFactory = null;

        if (sImplName.equals(_BlogAccountDialogEventHandler.class.getName())) {
            xFactory = Factory.createComponentFactory(_BlogAccountDialogEventHandler.class,
                    _BlogAccountDialogEventHandler.getServiceNames());
        }
    ...
    public static boolean __writeRegistryServiceInfo(XRegistryKey regKey) {
        System.out.println("OptionsDialogEventHandler::__writeRegistryServiceInfo");
        return Factory.writeRegistryServiceInfo(_BlogAccountDialogEventHandler.class.getName(),
                _BlogAccountDialogEventHandler.getServiceNames(),
                regKey);
    }
